                                     ...
                                     const Intersection &intersection) const
{
    ...
    const auto in_mode = node_data_container[node_based_graph.GetEdgeData(via_eid).annotation_data].travel_mode;
    ...
    const auto all_share_mode = std::all_of(first, last, [this, &in_mode](const auto &road) {
        return node_data_container[node_based_graph.GetEdgeData(road.eid).annotation_data].travel_mode == in_mode;
    });
